This is the code for an apparatus to play a piano based on midi inputs. The whole system runs on a micro-controller running [MicroPython](https://micropython.org/).
